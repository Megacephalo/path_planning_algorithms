...
Dijkstra::Dijkstra(const Grid& grid)
: Path_Planner(grid)
{} /* end of constructor */

void
Dijkstra::plan(const size_t& startRow, const size_t& startCol, const size_t& endRow, const size_t& endCol) {
...
void
Dijkstra::get_neighbors(const GridLocation& cell) {
...
bool
Dijkstra::is_closed(const GridLocation& cell) const {
	return ( closed_.find(cell) != closed_.end() ) ;
} /* End of is_closed */

bool
Dijkstra::not_opened(const GridLocation& cell) const {
